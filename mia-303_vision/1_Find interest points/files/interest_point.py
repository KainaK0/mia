...
class InterestPointExtractor:
  ...
  def corner_function(self, img):
    ...
    **********************************************************
    Hint: Compute image gradients, corresponding measures: (IxIx, IyIy, IxIy), the weighted sum of nearby derivative information using gaussian smoothing, and finally the cornerness reponse 
    """
